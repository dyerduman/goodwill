...
<!-- script for font sizer controls and size settings -->
  ...
  var size = parseInt($('body, .entry-content, .primary-navigation, body .metaslider.ms-theme-disjoint .flexslider ul.slides .caption-wrap .caption').css('font-size').replace("px", ""), 10);
  var incrementAmount = 2;
  var increments = 2;
  $("#largerFont").click(function(){
    var curSize = parseInt($('body, .entry-content, .primary-navigation, body .metaslider.ms-theme-disjoint .flexslider ul.slides .caption-wrap .caption').css('font-size').replace("px", ""), 10);

    $('body, .entry-content, .primary-navigation, body .metaslider.ms-theme-disjoint .flexslider ul.slides .caption-wrap .caption').css('font-size', curSize + incrementAmount);
  ...
  $("#smallerFont").click(function(){
    ...
    $('body, .entry-content, .primary-navigation, .metaslider.ms-theme-disjoint *').css('font-size', curSize - incrementAmount);
    if ((curSize - incrementAmount) <= (size - (incrementAmount * increments))) {
